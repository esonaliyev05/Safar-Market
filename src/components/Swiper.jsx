      ...
      <SwiperComponent
        ...
        pagination={{
          ...
          renderBullet: (index, className) => {
            return `<span class="${className} transition-all duration-300 w-3 h-3 sm:w-4 sm:h-4 rounded-full mx-1 bg-gray-300"></span>`;
          },
          bulletActiveClass:
      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div className="mx-auto max-w-[1280px] overflow-hidden px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-10">
              
              <div className="lg:w-1/2 w-full flex flex-col justify-center" data-aos="fade-right">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 break-words" data-aos="fade-up" data-aos-delay="100">
                  {slide.title}
                </h2>
                <p className="text-gray-600 mb-6 text-sm sm:text-base md:text-lg break-words" data-aos="fade-up" data-aos-delay="200">
                  {slide.description}
                </p>
                <button className="bg-emerald-700 text-white px-6 py-3 rounded-full font-medium hover:bg-emerald-800 transition mb-6 w-max" data-aos="zoom-in" data-aos-delay="300">
                  {slide.button}
                </button>
